(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.tns = factory());
  ...
  function tinySlider (options) {
    ...
    function initStructure() {
      ...
      outerWrapper.setAttribute('aria-roledescription', 'carousel'); // set container properties
    ...
    function updateSlideStatus() {
      ...
      forEach(slideItems, function (item, i) {
        ...
        if (i >= start && i <= end) {
          ...
          updateSlideFocusable(item, false); // hide slides
        } else {
          if (!hasAttr(item, 'aria-hidden')) {
            setAttrs(item, {
              'aria-hidden': 'true',
    ...
    function updateContentWrapperHeight(options = {
      reset: false
    }) {
      var wp = middleWrapper ? middleWrapper : innerWrapper;
      ...
      var {
        height: tallestItemHeight
      } = getTallestItem().getBoundingClientRect();
      var heightInPx = `${tallestItemHeight}px`; // set the height of the tallest item on the wrapper and all the slides

      setSlidesHeight(wp, heightInPx); // update slide positions
